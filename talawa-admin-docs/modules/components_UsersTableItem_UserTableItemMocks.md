...
[src/components/UsersTableItem/UserTableItemMocks.ts:6](https://github.com/AmitSharma512/talawa-admin/blob/2da9090/src/components/UsersTableItem/UserTableItemMocks.ts#L6)
